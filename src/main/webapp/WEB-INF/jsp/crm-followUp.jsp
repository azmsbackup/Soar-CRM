		...
		<div class="container-fluid">
					...
					<div class="page-title-box">
						<div class="page-title-right">
							<ol class="breadcrumb m-0">
								...
								<li class="breadcrumb-item active">FollowUp Calls</li>
							</ol>
						</div>
						<h4 class="page-title">FollowUp Calls</h4>
					</div>
				</div>
			</div>
			<!-- end page title -->
			...
			<div class="row">
				<div class="col-lg-12">
					...
					<!-- datatable-buttons -->
								<table id="followup-buttons" class="table table-striped">
										<input type="hidden" id="dt-title" value = "Allzone CRM - FollowUp Calls" />
                                        		...
                                        		<tr>
		                                           ...
		                                           <!--  <th  data-hide="all">Location</th> --> 
		                                           	...
		                                           	<th  data-field="createdDate" data-sortable="true">Follow-up Date</th>
                                       			 ...
                                       			 <tbody>
                                       			 <form:hidden path="frompage" value="dashboardfollowup"	/>	
                                       			 <form:hidden path="roleid" value="${sessionScope.RoleId}"	/>
												<c:forEach var="clien" items="${client.followupList}" varStatus="loop">
			                                      ...
			                                      <!--   <td>
													...
													<td>${clien.username}</td> 
              										<c:if test="${sessionScope.RoleId != '1'}">                                      
														...
														<td style="text-align: center"><a href="viewnotes?id=${clien.traceNo}&&clientName=${clien.clientName}&&userid=${clien.userId}&&frompage=dashboardfollowup"><button type="button"
...
$(document).ready(function() {
	var oTable = $('#followup-buttons').DataTable( {
	        dom: 'Bfrtip',
	        buttons: [
	       {
	           extend: 'pdf',
	           text:'Export to PDF',
	           footer: true,
	           title:"Allzone CRM - FollowUp Calls",
	           exportOptions: {
