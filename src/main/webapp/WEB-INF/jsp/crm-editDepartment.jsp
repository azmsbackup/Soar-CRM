                      ...
                      <!-- start page title -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="col-lg-6"> 
                                	 <form:form action="updatedepartment" method="post" modelAttribute="department" class="parsley-examples" >
                                	  <form:hidden path="departmentId" value="${department.departmentId}" />       
                                     <c:if test="${department.getFlag() == '1'}">
        							 <tr><p style="color:red;"><c:out value="Department Name already exists!" /></p></tr>
    								</c:if>
                                	...
                                	<div class="col-lg-3">                                            
                                      <div class="form-group">
                                            ...
                                            <input type="text" name="departmentCode" parsley-trigger="change" required value ="${department.departmentCode}"
                                                   placeholder="Enter Department Code" maxlength="15" class="form-control" id="departmentCode" readonly="true">
                                        </div>
