					...
					<div class="page-title-box">
						<div class="page-title-right">
							<ol class="breadcrumb m-0">
								...
								<li class="breadcrumb-item active">EmailSent</li>
							</ol>
						</div>
						<h4 class="page-title">Email Sent</h4>
					</div>
				</div>
			</div>
			<!-- end page title -->
                                           ...
                                           data-pagination="true" data-show-pagination-switch="true" class="table table-striped toggle-circle mb-0"> 
                                        		...
                                        		<tr>
		                                           ...
		                                           <!--  	<th  data-hide="all">Location</th> -->
                                       			  ...
                                       			  <form:hidden path="frompage" value="dashboardemail"	/>
                                       			  <form:hidden path="roleid" value="${sessionScope.RoleId}"	/>	
                                       			 <tbody>
												<c:forEach var="clien" items="${client.emailSentList}" varStatus="loop">
												...
												<tr>                                                                  
			                                     ...
			                                     <!--   <td>
													...
													<c:if test="${sessionScope.RoleId != '1'}">                                      
														...
														<td style="text-align: center"><a href="viewnotes?id=${clien.traceNo}&&clientName=${clien.clientName}&&userid=${clien.userId}&&frompage=dashboardemail"><button type="button"
