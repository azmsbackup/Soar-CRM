					...
					<div class="page-title-box">
						<div class="page-title-right">
							<ol class="breadcrumb m-0">
								...
								<li class="breadcrumb-item active">Overdue Email</li>
							</ol>
						</div>
						<h4 class="page-title">Overdue Email</h4>
					</div>
				</div>
			</div>
			<!-- end page title -->
					...
					<div class="card-box">
						...
						<div class="col-lg-12">
							...
							<form:hidden path="userId" id="userid" value="${client.userId}"/>   
							 <form:hidden path="frompage" value="dashboardoverdueemail"	/>
								<div class="row">
									<div class="col-12">
                                           ...
                                           data-pagination="true" data-show-pagination-switch="true" class="table table-striped toggle-circle mb-0"> 
                                        		...
                                        		<tr>
		                                            <th  data-field="id" data-sortable="true" data-toggle="true">Trace No</th>
		                                           	...
		                                           	<!-- <th  data-field="createdDate" data-sortable="true">Emailed Date</th>  -->
		                                           	<th  data-field="modifiedDate" data-sortable="true">Last Activity Date</th> 
		                                           	<th  data-field="name" data-sortable="true">Account Owner</th>
                                       			 ...
                                       			 <tbody>
												<c:forEach var="clien" items="${client.overdueEmailSentList}" varStatus="loop">
												...
												<tr>                                                                  
			                                       ...
			                                       <%--  <td>
													...
													<c:if test="${sessionScope.RoleId != '1'}">                                      
														...
														<td style="text-align: center"><a href="viewnotes?id=${clien.traceNo}&&clientName=${clien.clientName}&&userid=${clien.userId}&&frompage=dashboardoverdueemail"><button type="button"
