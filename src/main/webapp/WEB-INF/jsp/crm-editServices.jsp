                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="card-box">
                                    ...
                                    <form:form action="updateServices" method="post" modelAttribute="crmServices" class="parsley-examples" >
                                     <c:if test="${crmServices.getFlag() == '1'}">
        							 	<tr><p style="color:red;"><c:out value="Services Description already exists!!" /></p></tr>
    								</c:if> 
                                    <form:hidden path="servicesId" value="${crmServices.servicesId}" />                                  
                                      <div class="form-group">
                                            <label >Status Description<span class="text-danger">*</span></label>
                                            <input type="text" name="servicesDescription" parsley-trigger="change" required value ="${crmServices.servicesDescription}"
                                                   placeholder="Enter Services Description" maxlength="100" class="form-control" id="servicesDescription">
                                        </div>                                      
