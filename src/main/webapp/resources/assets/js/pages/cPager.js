    ...
    $.fn.cPager = function (config) {
        ...
        this.Run = function (config) {            
           ...
           this.createPage = function () {
               ...
               var html = '<div class="turn-num"></div>';
               html += '<ul class="turn-ul">';
               //首页+上一页
              
               if(config.pageIndex > 1)
                  html += '<li class="tz prev">Previous</li>';
               else
                  html += '<li class="tz prev notallowed" >Previous</li>';

               //小于6页 全部显示
               if(config.pageIndex <= 5)
               {
               ...
               if(config.pageIndex < config.pageCount)
                 html += '<li class="tz next">Next</li>';
               else
                 html += '<li class="tz next notallowed">Next</li>';
